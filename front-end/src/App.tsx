      ...
      {isGestModal ? ( 
        <div className='fixed inset-0 bg-black/50 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addEmail} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
       ...
       {isConfirmTripModal ? (
         ...
         <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
           ...
           <button type='submit' className=' w-full justify-center bg-lime-300 text-lime-950 rounded-lg px-5 h-14 font-medium flex items-center gap-2 hover:bg-lime-400'>
             Convidar
             <Plus className='size-5'/>
           </button>
         </div>
